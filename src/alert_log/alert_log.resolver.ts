...
export class AlertLogResolver {
    ...
    async findOneAlertLog(@Context() ctx: { req: Request }, @Args("id", { type: () => Int }) id: number): Promise<AlertLog> {
    ...
    async deleteAlertLog(@Context() ctx: { req: Request }, @Args("id", { type: () => Int }) id: number): Promise<AlertLog> {
